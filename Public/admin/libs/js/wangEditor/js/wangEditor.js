...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $widthInput = $('<input type="text" value="100%" style="width:50px;text-align:center;"/>');
        var $heightInput = $('<input type="text" value="98%" style="width:50px;text-align:center;"/>');
        ...
        $btnSubmit.click(function (e) {
            ...
            if ((isNaN(width) && width != '100%') || (isNaN(height) && height != '98%')) {
                alert('宽度或高度不是数字！');
                return;
            }
