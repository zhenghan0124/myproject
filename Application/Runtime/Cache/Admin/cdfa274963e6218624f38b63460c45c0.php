  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/index.php/Admin/Room/edit_roomtype" method="post">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="area" class="form-control" value="<?php echo ($data["area"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="area_en" class="form-control" value="<?php echo ($data["area_en"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="bed" class="form-control" value="<?php echo ($data["bed"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="bed_en" class="form-control" value="<?php echo ($data["bed_en"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="add" class="form-control" value="<?php echo ($data["add"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="add_en" class="form-control" value="<?php echo ($data["add_en"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="floor" class="form-control" value="<?php echo ($data["floor"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>图片(310*165)</label>
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic">
                    <ul>
                      <?php if(!empty($data["pic"])): ?><li>
                          <img src="/Uploads/<?php echo ($data["pic"]); ?>">
                          <input type="hidden" name="pic" value="<?php echo ($data["pic"]); ?>">
                          <span class="qy-upload-del"><i class="fa fa-remove"></i></span>
                        </li><?php endif; ?>
                      <li class="upload-pic-wrap" <?php if(!empty($data["pic"])): ?>style="display:none;"<?php endif; ?>>
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="hp_hcode" class="form-control" value="<?php echo ($data["hp_hcode"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="hp_picode" class="form-control" value="<?php echo ($data["hp_picode"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="start_date" class="form-control form-control-datepicker" value="<?php echo ($data["start_date"]); ?>" readonly>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="end_date" class="form-control form-control-datepicker" value="<?php echo ($data["end_date"]); ?>" readonly>
                </div>
              </div>
            </div>
            <?php if(($data["paytype"]) == "0"): ?><div class="form-group">
              <label>支付方式</label>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="bed_en" class="form-control" value="<?php echo ($data["bed"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="bedadd" class="form-control" value="<?php echo ($data["bedadd"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="bedadd_en" class="form-control" value="<?php echo ($data["bedadd"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="num" class="form-control" value="<?php echo ($data["num"]); ?>">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <textarea name="description" cols="30" rows="10" class="form-control" placeholder=""><?php echo ($data["description"]); ?></textarea>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <textarea name="description_en" cols="30" rows="10" class="form-control" placeholder=""><?php echo ($data["description_en"]); ?></textarea>
                </div>
              </div>
            </div> -->
