  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/index.php/Admin/Honor/index" method="post">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-2">
                    <ul>
                      <?php if(!empty($data["banner"])): ?><li>
                          <img src="/Uploads/<?php echo ($data["banner"]); ?>">
                          <input type="hidden" name="banner" value="<?php echo ($data["banner"]); ?>">
                          <span class="qy-upload-del"><i class="fa fa-remove"></i></span>
                        </li><?php endif; ?>
                      <li class="upload-pic-wrap" <?php if(!empty($data["banner"])): ?>style="display:none;"<?php endif; ?>>
                      <i class="fa fa-plus"></i>
                      <input type="file" class="upload-pic-button" name="qy_upload">
                      </li>
                    </ul>
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <script id="editor" name="content" type="text/plain" style="width:100%;height:500px;"><?php echo ($data["content"]); ?></script>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <script id="editor_en" name="content_en" type="text/plain" style="width:100%;height:500px;"><?php echo ($data["content_en"]); ?></script>
                </div>
              </div>
            </div>
            ...
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="time" class="form-control form-control-datepicker" value="<?php echo (date('Y-m-d',$data["time"])); ?>" readonly>
                </div>
              </div>
            </div> -->
...
<!-- core -->
  ...
  <script type="text/javascript">
    ...
    $('.qy-upload-2').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","banner",0);
