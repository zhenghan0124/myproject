  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/index.php/Admin/About/index" method="post">
            <div class="form-group">
              <label>banner图片(1920*1080)</label>
              <div class="row">
                <div class="col-md-12">
...
<!-- core -->
  ...
  <script type="text/javascript">
    $('.qy-upload').qy_upload("<?php echo U('Upload/index',['width'=>1200,'height'=>620]);?>","pic",1);
  </script>
  <script>
