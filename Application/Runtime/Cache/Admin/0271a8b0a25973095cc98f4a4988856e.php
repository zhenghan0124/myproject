...
<div class="padding">
  ...
  <a href="<?php echo U('add_picture');?>" class="btn btn-fw primary m-b">新增</a>
  <div class="row">
    <div class="col-sm-12">
      <div class="box">
        <table class="table table-striped b-t">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td><a href="<?php echo U('edit_picture',array('id' => $data['id']));?>">编辑</a>
                <a href="<?php echo U('del_picture',array('id'=>$data['id']));?>" class="text-danger" onclick="return confirm('确认要删除吗，删除后无法恢复？')">删除</a></td>
