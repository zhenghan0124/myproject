...
<head>
  ...
  <!-- datepicker -->
  <link rel="stylesheet" type="text/css" href="/anlu/Public/admin/libs/jquery/bootstrap-datepicker/css/datepicker.css">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/anlu/index.php/Admin/Dinner/add_picture" method="post">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <textarea name="description" cols="30" rows="10" class="form-control" placeholder=""></textarea>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <textarea name="description_en" cols="30" rows="10" class="form-control" placeholder=""></textarea>
                </div>
              </div>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_one_en" class="form-control">
                </div>
              </div>
            </div>
            <!-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_two_en" class="form-control">
                </div>
              </div>
            </div>
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-3">
                    <ul>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
                        <input type="file" class="upload-pic-button" name="qy_upload">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_three_en" class="form-control">
                </div>
              </div>
            </div>
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-4">
                    <ul>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
                        <input type="file" class="upload-pic-button" name="qy_upload">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_four_en" class="form-control">
                </div>
              </div>
            </div>
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-5">
                    <ul>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
                        <input type="file" class="upload-pic-button" name="qy_upload">
            ...
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_five" class="form-control">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_five_en" class="form-control">
                </div>
              </div>
            </div> -->
            <!-- <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-6">
                    <ul>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
                        <input type="file" class="upload-pic-button" name="qy_upload">
            ...
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_six" class="form-control">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type="text" name="title_six_en" class="form-control">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-7">
                    <ul>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
                        <input type="file" class="upload-pic-button" name="qy_upload">
...
<!-- core -->
  ...
  <script type="text/javascript">
    $('.qy-upload-1').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic",0);
    $('.qy-upload-2').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic1",0);
    $('.qy-upload-3').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic2",0);
    $('.qy-upload-4').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic3",0);
    $('.qy-upload-5').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic4",0);
    $('.qy-upload-6').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic5",0);
    $('.qy-upload-7').qy_upload("<?php echo U('Upload/index',['width'=>450,'height'=>300]);?>","pic6",0);
  </script>
