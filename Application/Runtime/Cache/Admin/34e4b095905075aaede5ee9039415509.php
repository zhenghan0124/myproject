  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" class="validate" action="/index.php/Admin/Product/index" method="post">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-2">
                    <ul>
                      <?php if(!empty($data["pic1"])): if(is_array($data["pic1"])): $i = 0; $__LIST__ = $data["pic1"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <img src="/Uploads/<?php echo ($vo); ?>">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="qy-upload upload-pic qy-upload-3">
                    <ul>
                      <?php if(!empty($data["pic2"])): if(is_array($data["pic2"])): $i = 0; $__LIST__ = $data["pic2"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <img src="/Uploads/<?php echo ($vo); ?>">
                            <input type="hidden" name="pic2[]" value="<?php echo ($vo); ?>">
                            <span class="qy-upload-del"><i class="fa fa-remove"></i></span>
                          </li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                      <li class="upload-pic-wrap">
                        <i class="fa fa-plus"></i>
...
<!-- core -->
  ...
  <script type="text/javascript">
                    ...
                    $('.qy-upload-3').qy_upload("<?php echo U('Upload/index',['width'=>1200,'height'=>620]);?>","pic2",1);
                  </script>
  <script>
