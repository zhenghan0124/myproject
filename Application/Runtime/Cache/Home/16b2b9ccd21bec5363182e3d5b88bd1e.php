    ...
    <main class="main activity" id="main">
        ...
        <div class="sbmain md">
            <section class="section section--show">
                <article class="article article--page" style="padding-left: 10%; padding-right: 10%;">

                    <h2><?php echo (L("tiyan")); ?> </h2>
                    <p>
            ...
            <section class="section section--show">
                <?php if(is_array($huodong)): $i = 0; $__LIST__ = $huodong;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "1"): ?><div class="grid--column-2">
                    ...
                    <div class="grid__item">
                        <img src="/Uploads/<?php echo ($vo["pic"]); ?>" alt="Alternate Text" />
                    </div>
                </div>
                <div class="clearfix" style="height: 20px; background: #f0f0f0;"></div>
                ...
                <div class="clearfix" style="height: 20px; background: #f0f0f0;"></div><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                <!-- <div class="grid--column-2">
                    <div class="grid__item">
                        <img src="/Public/home/img/activity/2.png" alt="Alternate Text" />
                    </div>
                    <div class="grid__item">
                        <article class="article article--page">
                ...
                <div class="grid--column-2">
                    ...
                    <div class="grid__item">
                        <img src="/Public/home/img/activity/3.png" alt="Alternate Text" />
                    </div>
                </div>
                <div class="clearfix" style="height: 20px; background: #f0f0f0;"></div>
                ...
                <div class="grid--column-2">
                    <div class="grid__item">
                        <img src="/Public/home/img/activity/4.png" alt="Alternate Text" />
                    </div>
                    <div class="grid__item">
                        <article class="article article--page">
                ...
                <div class="grid--column-2">
                    ...
                    <div class="grid__item">
                        <img src="/Public/home/img/activity/5.png" alt="Alternate Text" />
                    </div>
                </div>
                <div class="clearfix" style="height: 20px; background: #f0f0f0;"></div> -->
            </section>
