...
<head>
    ...
    <link href="/anlu/Public/home/css/colorbox.css" rel="stylesheet" type="text/css" defer>
    <link href="/anlu/Public/home/css/main.css" rel="stylesheet" type="text/css" defer>
    <link href="http://at.alicdn.com/t/font_1035999_9z3gkng2vgj.css" rel="stylesheet" type="text/css" defer>
    <link href="/anlu/Public/home/css/animations.css" rel="stylesheet" type="text/css" defer>
    <link href="/anlu/Public/home/css/perfect-scrollbar.css" rel="stylesheet" type="text/css" defer>


    <link href="/anlu/Public/home/css/font-awesome.min.css" rel="stylesheet" defer />
    <link href="/anlu/Public/home/css/plus.css" rel="stylesheet" type="text/css" defer>

    <script src="/anlu/Public/home/js/jquery.min.js"></script>
	<script src="/anlu/Public/home/js/layer/layer.js"></script>
    ...
    <link href="/anlu/Public/home/css/swiper.min.css" rel="stylesheet" />
    <script src="/anlu/Public/home/js/swiper.min.js"></script>
    <style>
        .swiper-container {
            width: 100%;
            height: 300px;
        ...
        .swiper-button-next.swiper-button-white,  .swiper-button-prev.swiper-button-white {    display: flex;
    align-items: center;
            background-image: none;
        }

            .swiper-button-next.swiper-button-white div,   .swiper-button-prev.swiper-button-white div {
                color: #000000;
                background: #fff;
                border-radius: 100%;
              height: 23px;
            ...
            .swiper-button-next.swiper-button-white i,   .swiper-button-prev.swiper-button-white i {
                font-size: 24px;
                position: relative;
                left: 0px;
            }
...
<body class="page page--sticky-book-mobile page--home " data-page-type="home">
                    ...
                    <div class="logo logo--alila">
                        <a class="logo__link" href="javascript:;">
                            <div class="logo__image">
                                <img src="/anlu/Public/home/img/close.png" alt="" style="position: absolute; right: 21px;">
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="header__logo">
                ...
                <div class="header__image">
                    <a href="<?php echo U('Index/index');?>">
                        <img src="/anlu/Public/home/img/logo.jpg" /></a>
    ...
    <header class="headerWidget10 navWidget" id="headerWidget3151">
        <div class="navigator">
            <div class="topBar">
                ...
                <div class="logoWrap">
                    <a href="javascript:;">
                        <img src="/anlu/Public/home/img/logosmall.jpg" alt="hotel logo" class="logo">
                    </a>
                </div>
    ...
    <main class="main" id="main" style="height: 100vh;">
        ...
        <div class="swiper-container gallery-top">
            <div class="swiper-wrapper">
                <?php if(is_array($data["pic"])): $i = 0; $__LIST__ = $data["pic"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide" style="background-image: url(/Uploads/<?php echo ($vo); ?>)"></div><?php endforeach; endif; else: echo "" ;endif; ?>
                <!-- <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/4.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/2.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/3.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/9.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/5.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/6.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/7.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/8.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/1.jpg)"></div>
                <div class="swiper-slide" style="background-image: url(/anlu/Public/home/img/photo/10.jpg)"></div> -->
            </div>
        ...
        <div class="swiper-container gallery-thumbs">
            ...
            <div class="swiper-button-next swiper-button-white">
                <div><i class="iconfont icon-1202youjiantou"></i></div>
            </div>
            <div class="swiper-button-prev swiper-button-white">
                <div><i class="iconfont icon-left-copy"></i></div>
            </div>
        </div>
        <script>
...
<block name="footer">
                ...
                <div class="footer__logos footer__logos--follow" style="text-align: left;">
                    ...
                    <ul class="footer__logos-list icon__list">
                        <li class="footer__logos-item icon__item">
                            ...
                            <div class="imgwrap">
                                <img src="/anlu/Public/home/img/weixin.png" class="img" />
                            </div>
    ...
    <link href="/anlu/Public/home/css/media.css" rel="stylesheet" />
