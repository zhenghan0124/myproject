...
<head>
    ...
    <style>
           ...
           input,select{
            ...
            input.ca {
            background-image:url('/Public/home/img/ca.jpg');    
        ...
        <div class="sborderWrap">
            <div class="sborder">
                ...
                <table>
                    <tr>
                        <td>
                            <div class="title"><?php echo (L("riqi")); ?></div>
                            <div class="box">
                                <span class="title1"><?php echo (L("start")); ?></span>
                                <input type="text" class="ca" id="start" onchange="changedate()" name="start" value="<?php echo date("Y-m-d") ?>" />
                            </div>
                            <div class="box">
                                <span class="title1"><?php echo (L("end")); ?></span>
                                <input type="text" class="ca" id="end" name="end" value="<?php echo date("Y-m-d",strtotime("+1 day")) ?>" />
                            </div>

                            <div class="title"><?php echo (L("kefang")); ?></div>
                            <div class="box">
                                <span class="title1"><?php echo (L("nums")); ?></span>
                                <select name="nums">
                            ...
                            <div class="box">
                                <span class="title1"><?php echo (L("code")); ?></span>
                                <input type="text" name="code"/>
                            </div>

                        </td>
                        <td>
                            <div class="title"><?php echo (L("xuanze")); ?></div>
                            <div class="box">
                                <span class="title1"><?php echo (L("adult")); ?></span>
                                <select name="adult">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                            ...
                            <div class="box">
                                <span class="title1"><?php echo (L("child")); ?></span>
                                <select name="child">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                            ...
                            <div class="box">
                                <span class="title1"><?php echo (L("days")); ?></span>
                                <select name="day">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                    ...
                    <tr>
                        <td colspan="2" class="text-center">
                            <a href="javascript::" onclick="check()"><span class="next btn22"><?php echo (L("next")); ?></span></a>
                            <!-- <button><span class="next btn22">下一步</span></button> -->
                        </td>
                    </tr>
                </table>
                </form>
                <script>
                  function changedate(){
					return;
                    var bdate = document.getElementById("start").value;
                    ...
                    document.getElementById("end").value = year+'-'+month+'-'+date;
                  }
                </script>
                <script>
                function check(){
