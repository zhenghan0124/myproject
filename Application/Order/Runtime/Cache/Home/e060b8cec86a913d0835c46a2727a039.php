    ...
    <div class="top-link">
      <div class="container clearfix">
        ...
        <div class="link-list fl">
          <p>您当前的位置：<a href="">首页</a> > <a href="">酒店概况</a> > <a href="">健身中心</a></p>
        </div>
      </div>
    </div>
  </div>
  <div class="summary-gym">
    <div class="container">
      <h3>餐饮美食</h3>
      <div class="line-blue">

      </div>
      <div class="summary-gym-show">
        <div class="row">
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sg1.jpg" alt="">
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sg2.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sg3.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sg4.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
