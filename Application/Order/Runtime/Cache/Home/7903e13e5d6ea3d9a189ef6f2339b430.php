...
<div class="header-all clearfix">
    ...
    <div class="top-link">
      <div class="container clearfix">
        ...
        <div class="link-list fl">
          <p>您当前的位置：<a href="">首页</a> > <a href="">酒店概况</a> > <a href="">餐饮美食</a></p>
        </div>
      </div>
    </div>
  </div>
  <div class="summary-food">
    <div class="container">
      ...
      <div class="summary-food-show">
        <div class="row">
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sf1.jpg" alt="">
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sf2.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sf3.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
          ...
          <div class="col-md-6">
            <div class="sum-box">
              <img src="/Public/home/img/sf4.jpg" alt="">
              <div class="textarea-content">
                <a href="">
                  <span class="line line-top"></span>
                  <span class="line line-left"></span>
        ...
        <ul class="clearfix">
          ...
          <li class="f-list-item fl">
            ...
            <ul>
              ...
              <li><a href="<?php echo U('Hotel/gym');?>">健身相册</a></li>
            </ul>
          </li>
          <li class="f-list-item fl">
            <p>宴会会议</p>
